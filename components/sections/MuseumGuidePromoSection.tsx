...
const valueProps = [
  {
    ...
    description: 'Az egyetlen magyar nyelven elérhető interaktív Louvre útikalauz.',
  },
  {
    icon: Coins,
    title: 'Spórolj pénzt',
    description: 'Élő idegenvezetés 50-60€, a belépő mindössze 22€ — a digitális guide mellé.',
  },
  {
    icon: Smartphone,
    title: 'Interaktív élmény',
    description: 'Húzogatható kártyák, beépített térkép, lenyűgöző sztorik minden alkotáshoz.',
  },
  {
    icon: Clock,
    title: 'Mindig elérhető',
    description: 'Nincs időpont-egyeztetés — használd bármikor, a saját tempódban.',
  },
]

export default function MuseumGuidePromoSection() {
  return (
      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        >
          ...
          <p className="mx-auto max-w-2xl text-lg text-parisian-grey-600 md:text-xl">
            Az egyetlen magyar nyelvu interaktiv Louvre-kalauz. Gondosan valogatott alkotasok,
            lenyugozo sztorik, utvonalterv — mindezt a zsebedben.
          </p>
        </motion.div>
            ...
            <div className="group relative overflow-hidden rounded-2xl border-2 border-parisian-beige-200 bg-white shadow-lg transition-all hover:shadow-2xl hover:border-parisian-beige-400">
              ...
              <div className="relative bg-gradient-to-r from-[#1a1a2e] to-[#2d2d44] p-8 text-center text-white">
                ...
                <div className="relative">
                  ...
                  <h3 className="font-playfair text-3xl font-bold">Fedezd fel a Louvre kincseit</h3>
                  <p className="mt-2 text-sm opacity-80">Interaktiv kartyak, terkep, sztorik</p>
                </div>
              </div>
              ...
              <div className="space-y-5 p-8">
                <p className="text-center text-parisian-grey-600">
                  12-15 gondosan valogatott alkotas, mindegyikhez lenyugozo sztori es erdekes teny.
                  Logikus utvonal a Louvre-ban, hogy semmit ne hagyj ki.
                </p>
                ...
                <div className="space-y-3 border-y border-parisian-beige-100 py-5">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-parisian-grey-700">Interaktiv, lapozgathato kartyak</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Landmark className="h-5 w-5 flex-shrink-0 text-parisian-beige-500" />
                    <span className="text-sm text-parisian-grey-700">Beepitett Louvre terkep utvonallal</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Languages className="h-5 w-5 flex-shrink-0 text-parisian-beige-500" />
                    <span className="text-sm text-parisian-grey-700">Teljes egeszeben magyarul</span>
                  </div>
                </div>
        ...
        >
          ...
          >
            <Landmark className="h-4 w-4" />
            Utikalauz megvasarlasa — 4 990 Ft
          </Link>
          <p className="mt-3 text-sm text-parisian-grey-400">
            Egyszeri vasarlas, korlátlan hasznalat
          </p>
        </motion.div>
      </div>
    </section>
