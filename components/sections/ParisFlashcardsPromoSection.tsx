...
export default function ParisFlashcardsPromoSection() {
  return (
      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        >
          ...
          <p className="mx-auto max-w-2xl text-lg text-parisian-grey-600 md:text-xl">
            Sajátítsd el Párizst az interaktív flashcard csomagjainkkal. Tanulj helyi kifejezéseket, metrótérképeket, kulturális tippeket és még sok mást!
          </p>
        </motion.div>
          ...
          <Link href="/paris-flashcards">
            <div className="group relative overflow-hidden rounded-2xl border-2 border-parisian-beige-200 bg-white shadow-lg transition-all hover:shadow-2xl hover:border-parisian-beige-400">
              ...
              <div className="bg-gradient-to-r from-parisian-beige-400 to-parisian-beige-500 p-8 text-center text-white">
                <h3 className="font-playfair text-3xl font-bold">Párizs</h3>
                <p className="mt-2 text-sm opacity-90">Nyelvtanulási csomag</p>
              </div>

              {/* Content */}
              <div className="space-y-6 p-8">
                <p className="text-center text-parisian-grey-600">
                  Felfedezd az összes Párizs-specifikus tanulási témakört. Demo kártyákat megtekinthetsz ingyenesen, az összes többi után pedig szükséges egy Város Pass.
                </p>
                ...
                <div className="space-y-3 border-y border-parisian-beige-100 py-6">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-parisian-grey-700">Több témakör</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Lock className="h-5 w-5 flex-shrink-0 text-parisian-beige-500" />
                    <span className="text-sm text-parisian-grey-700">Demo kártyák mindenki számára</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Sparkles className="h-5 w-5 flex-shrink-0 text-parisian-beige-500" />
                    <span className="text-sm text-parisian-grey-700">Pass után teljes hozzáférés</span>
                  </div>
                </div>
        ...
        >
          <h3 className="mb-2 font-playfair text-2xl font-bold text-parisian-grey-800">
            Más városok érdekelnek?
          </h3>
          <p className="mb-6 text-parisian-grey-600">
            Fedezd fel a tanulási csomagokat más nagyvárosok számára is.
          </p>
          <Link
            href="/pricing"
